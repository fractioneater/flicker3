...
public:
   ...
   * @param tree A tree returned by parse_antlr()
   */
  // void output_dot(antlr4::tree::ParseTree* tree); // See note above implementation.

  /**
   * Parses the input token stream with an ANTLR4-generated parser and returns the created parse tree.
   * @return The parse tree (AST)
   */
  antlr::flicker::ProgramContext* parse_antlr();
