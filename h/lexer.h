...
enum TokenType {
  ...
  TOKEN_PLUS, TOKEN_SLASH, TOKEN_PERCENT, TOKEN_PIPE, TOKEN_CARET, TOKEN_AMPERSAND, TOKEN_TILDE,
  // 1-3 character tokens (15 - 35)
  TOKEN_DOT, TOKEN_DOT_DOT, TOKEN_DOT_DOT_LT,
  TOKEN_QUEST, TOKEN_QUEST_QUEST, TOKEN_QUEST_DOT,
  ...
  TOKEN_IN, TOKEN_IS, TOKEN_NIL, TOKEN_NOT, TOKEN_OF, TOKEN_OR, TOKEN_OVERRIDE, TOKEN_PASS, TOKEN_PRINT, TOKEN_PRINT_ERROR, TOKEN_PRIVATE, TOKEN_RETURN,
